...
<head>
    ...
    <link rel="stylesheet" href="assets\plugins\owl-carousel\owl-carousel\owl.css">
    <link rel="stylesheet" href="assets\plugins\owl-carousel\owl-carousel\owl (1).css">
    <link rel="stylesheet" href="assets\plugins\owl-carousel\owl-carousel\owl (2).css">
    <link rel="stylesheet" href="assets\plugins\summernote\dist\summernote.css">
    <link rel="stylesheet" href="assets\plugins\fullcalendar\fullcalendar\fullcalendar.css">
    <link rel="stylesheet" href="assets\plugins\toastr\toastr.css">
    <link rel="stylesheet" href="assets\plugins\bootstrap-select\bootstrap-select.css">
    <link rel="stylesheet" href="assets\plugins\bootstrap-switch\dist\css\bootstrap3\bootstrap-switch.css">
    <link rel="stylesheet" href="assets\plugins\DataTables\media\css\DT_bootstrap.css">
    <link rel="stylesheet" href="assets\plugins\bootstrap-fileupload\bootstrap-fileupload.css">
    <link rel="stylesheet" href="assets\plugins\bootstrap-daterangepicker\daterangepicker-bs3.css">
    <!-- end: CSS REQUIRED FOR THIS SUBVIEW CONTENTS-->
    <!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
    <link rel="stylesheet" href="assets\plugins\bootstrap-touchspin\dist\jquery.bootstrap-touchspin.css">
    <link rel="stylesheet" href="assets\plugins\select2\select2.css">
    <link rel="stylesheet" href="assets\plugins\datepicker\css\datepicker.css">
    <link rel="stylesheet" href="assets\plugins\bootstrap-timepicker\css\bootstrap-timepicker.css">
    <link rel="stylesheet" href="assets\plugins\bootstrap-colorpicker\css\bootstrap-colorpicker.css">
    <link rel="stylesheet" href="assets\plugins\bootstrap-colorpalette\css\bootstrap-colorpalette.css">
    <link rel="stylesheet" href="assets\plugins\jQuery-Tags-Input\jquery.css">
    <!-- end: CSS REQUIRED FOR THIS PAGE ONLY -->
    <!-- start: CORE CSS -->
    <link rel="stylesheet" href="assets\css\styles.css">
    <link rel="stylesheet" href="assets\css\styles-responsive.css">
    <link rel="stylesheet" href="assets\css\plugins.css">
    <link rel="stylesheet" href="assets\css\themes\theme-default.css" type="text/css" id="skin_color">
                    ...
                    <div class="input-box">
                        <div class="input">
                            <select name="layout" class="form-control">
                                <option value="default">Wide<option value="boxed">Boxed
                            </select>
                        </div>
                    </div>
                    <div class="box-title">
                    ...
                    <div class="input-box">
                        <div class="input">
                            <select name="header" class="form-control">
                                <option value="fixed">Fixed<option value="default">Default
                            </select>
                        </div>
                    </div>
                    <div class="box-title">
                    ...
                    <div class="input-box">
                        <div class="input">
                            <select name="footer" class="form-control">
                                <option value="default">Default<option value="fixed">Fixed
                            </select>
                        </div>
                    </div>
                    <div class="box-title">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Rit <span class="text-bold">Toevoegen</span></h4>
                            ...
                            <div class="panel-body">
                                <form role="form" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="field_car">
                                            Auto
                                        </label>
                                        <div class="col-sm-9">
                                            <select id="field_car" name="car" class="form-control search-select">
                                                <option value="">&nbsp;</option>
                                                <option value="1">01-BT-KB</option>
                                                <option value="2">PP-91-HX</option>
                                                <option value="3">KZ-05-LT</option>
                                                <option value="4">52-ZSK-5</option>
                                                <option value="5">1-KBB-00</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="field_date">
                                            Datum
                                        </label>
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input type="text"id="field_date" data-date-format="yyyy-mm-dd" data-date-viewmode="years" class="form-control date-picker" value="<?=date('Y-m-d');?>">
                                                <span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="field_begin_km">
                                            Begin kilometer
                                        </label>
                                        <div class="col-sm-9">
                                            <input id="field_begin_km" type="text" value="0" name="field_begin_km" class="km_spin">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="field_end_km">
                                            Eind kilometer
                                        </label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="field_from">
                                            Vanaf
                                        </label>
                                        <div class="col-sm-9">
                                            <input type="text" placeholder="Vanaf" id="field_from" name="from" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="field_via">
                                            Via
                                        </label>
                                        <div class="col-sm-9">
                                            <input type="text" placeholder="Via" id="field_via" name="via" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="field_destination">
                                            Bestemming
                                        </label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="field_ride_type">
                                            Soort rit
                                        </label>
                                        <div class="col-sm-9">
                                            <select id="field_ride_type" name="ride_type" class="form-control">
                                                <option value="">Selecteer
                                                <option value="1">Zakelijk
                                                <option value="2">Woon-Werk
                                                <option value="3">Prive
                                            </select>
                                        </div>
                                    </div>
                                    <div class="checkbox">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <select class="form-control selectpicker event-categories">
                                <option data-content="<span class='event-category event-cancelled'>Cancelled</span>" value="event-cancelled">Cancelled
                                <option data-content="<span class='event-category event-home'>Home</span>" value="event-home">Home
                                <option data-content="<span class='event-category event-overtime'>Overtime</span>" value="event-overtime">Overtime
                                <option data-content="<span class='event-category event-generic'>Generic</span>" value="event-generic" selected="selected">Generic
                                <option data-content="<span class='event-category event-job'>Job</span>" value="event-job">Job
                                <option data-content="<span class='event-category event-offsite'>Off-site work</span>" value="event-offsite">Off-site work
                                <option data-content="<span class='event-category event-todo'>To Do</span>" value="event-todo">To Do
                            </select>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="permits" class="form-control contributor-permits">
                                <option value="View and Edit">View and Edit
                                <option value="View Only">View Only
                            </select>
                        </div>
                        <div class="form-group">
...
<!--<![endif]-->
<script src="assets\plugins\jquery-ui\jquery-ui-1.10.2.custom.js"></script>
<script src="assets\plugins\bootstrap\js\bootstrap.js"></script>
<script src="assets\plugins\blockUI\jquery.js"></script>
<script src="assets\plugins\iCheck\jquery.icheck.js"></script>
<script src="assets\plugins\moment\min\moment.js"></script>
<script src="assets\plugins\perfect-scrollbar\src\jquery.js"></script>
<script src="assets\plugins\perfect-scrollbar\src\perfect-scrollbar.js"></script>
<script src="assets\plugins\bootbox\bootbox.js"></script>
<script src="assets\plugins\jquery.scrollTo\jquery.scrollTo.js"></script>
<script src="assets\plugins\ScrollToFixed\jquery-scrolltofixed-min.js"></script>
<script src="assets\plugins\jquery.appear\jquery.js"></script>
<script src="assets\plugins\jquery-cookie\jquery.js"></script>
<script src="assets\plugins\velocity\jquery.velocity.js"></script>
<script src="assets\plugins\TouchSwipe\jquery.touchSwipe.js"></script>
<!-- end: MAIN JAVASCRIPTS -->
<!-- start: JAVASCRIPTS REQUIRED FOR SUBVIEW CONTENTS -->
<script src="assets\plugins\owl-carousel\owl-carousel\owl.js"></script>
<script src="assets\plugins\jquery-mockjax\jquery.js"></script>
<script src="assets\plugins\toastr\toastr.js"></script>
<script src="assets\plugins\bootstrap-modal\js\bootstrap-modal.js"></script>
<script src="assets\plugins\bootstrap-modal\js\bootstrap-modalmanager.js"></script>
<script src="assets\plugins\fullcalendar\fullcalendar\fullcalendar.js"></script>
<script src="assets\plugins\bootstrap-switch\dist\js\bootstrap-switch.js"></script>
...
<script src="assets\plugins\truncate\jquery.js"></script>
...
<script src="assets\plugins\jquery-inputlimiter\jquery.inputlimiter.1.3.1.js"></script>
<script src="assets\plugins\autosize\jquery.autosize.js"></script>
<script src="assets\plugins\select2\select2.js"></script>
<script src="assets\plugins\jquery.maskedinput\src\jquery.js"></script>
<script src="assets\plugins\jquery-inputlimiter\jquery.inputlimiter.1.3.1.js"></script>
<script src="assets\plugins\jquery-maskmoney\jquery.js"></script>
...
<script src="assets\plugins\bootstrap-touchspin\dist\jquery.bootstrap-touchspin.js"></script>
<script src="assets\plugins\jQuery-Tags-Input\jquery.js"></script>
<script src="assets\plugins\bootstrap-fileupload\bootstrap-fileupload.js"></script>
<script src="assets\plugins\ckeditor\ckeditor.js"></script>
<script src="assets\plugins\ckeditor\adapters\jquery.js"></script>
<script src="assets\custom\js\registratie_rit_toevoegen.js"></script>
